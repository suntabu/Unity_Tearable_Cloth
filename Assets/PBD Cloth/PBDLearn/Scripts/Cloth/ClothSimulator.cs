...
namespace PBDLearn
{
    ...
    public class ClothSimulator
    {
        ...
        {
            get { return _meshModifier.vertexCount; }
        }


        public NativeArray<float3> positions
        {
            get { return _meshModifier.vertices; }
        }

        public NativeArray<float3> normals
        {
            get { return _meshModifier.normals; }
        }

        public NativeArray<float3> predictPositions
        {
            get { return _predictPositions; }
        }

        public float compressStiffness
        {
            get { return _setting.compressStiffness; }
        }

        public float stretchStiffness
        {
            get { return _setting.stretchStiffness; }
        }

        public int distanceConstraintCount
        {
            get { return _distanceConstraints.Length; }
        }
        ...
        {
            get { return _setting.constraintSolverIteratorCount; }
        }
        ...
        private JobHandle StartBendConstraintsJob(JobHandle depend, int iterIndex)
        {
            ...
            job.di = di;
            job.bendStiffness =
                GetStiffnessForIteration(this._setting.bendStiffness, this.constraintSolverIteratorCount);
        ...
        private void ApplyPhysicalSimulationToRigidbodies()
        {
            for (var i = 0; i < _rigidBodyForceApplys.Length; i++)
            {
                ...
                _colliderProxies[forceInfo.entityId].attachedRigidbody
                    .AddForce(forceInfo.velocity, ForceMode.VelocityChange);
            }
        }
